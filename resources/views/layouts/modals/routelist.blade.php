...
<div class="modal fade bottom modal-content-clickable" data-backdrop="false" id="fullHeightModalBottom" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog routelist modal-full-height modal-bottom" role="document">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row mx-5 my-5">
                            <div class="col-6">
                                ...
                                <a class="btn btn-primary btn-md" onclick="">More</a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row mx-5 my-5">
                            <div class="col-6">
                                ...
                                <!-- Post title -->
                                <h3 class="font-weight-bold mb-3"><strong>Храм Василия Блаженного</strong>
                                    <p style="font-size: 14px;"><i class="fa fa-location-arrow" aria-hidden="true"></i> [7495] 3</p>
                                </h3>
                                ...
                                <!-- Read more button -->
                                <a class="btn btn-primary btn-md" data-toggle="modal" data-target="#basicExampleModalMerchCheckin">Check-in</a>
